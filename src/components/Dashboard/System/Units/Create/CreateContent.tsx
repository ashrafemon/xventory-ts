...
import { createUnit } from "../../../../../store/actions/dashboard/system/unitActions";
    ...
    const submitHandler = (e) => {
        ...
        if(!nameValidate && !codeValidate){
            ...
            Object.keys(form).forEach((key) => {
                if (key !== "storeList") {
                    unitData[key] = form[key];
                } else {
                    form.storeList.forEach((item) => {
                        unitData[key].push({ id: item.id });
                    });
                }
            });

            dispatch(createUnit(unitData, resetForm));
        }
    };
